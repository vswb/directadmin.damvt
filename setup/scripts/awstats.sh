...
HTTPPATH=http://directadmin-files.fsofts.com/services/all/awstats
...
#cd ${REALPATH}/tools
#wget -O awstats_url.patch http://directadmin-files.fsofts.com/services/custombuild/patches/awstats_url.patch
